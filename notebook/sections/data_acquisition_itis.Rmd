...
L.V.: this header (knitr::opts_chunk$set(eval=run.itis.acquisition)) is a reference to the variable established at the beginning of this document.  If run.itis.aquisition == TRUE it will run the code chunk.
