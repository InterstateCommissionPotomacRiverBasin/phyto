...
this is a modified version of scores_ratings created for use with VA_ODU data. DO NOT USE THIS SECTION if you are pulling data from CEDR.  Use the master branch of phyto2 which uses scores_ratings instead.
