...
L.V.: this is a modified version of scores_ratings created for use with VA_ODU data. DO NOT USE THIS SECTION if you are pulling data from CEDR.  Use the master branch of phyto which uses scores_ratings instead.
...
L.V.: freshwater and oligohaline salinity zones for both spring and summer have been commented out due to VA_ODU data not including them and this resulting in Zach's custom error being flagged, halting the program.  I would like to re-write it to pypass the code when such salzones aren't included, when time allows.
...
L.V.: functions for salzones not included in VA_ODU data have been commented out below
