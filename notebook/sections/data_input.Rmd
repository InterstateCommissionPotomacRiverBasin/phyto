...
data.table::fwrite(file.path(rprojroot::find_rstudio_root_file(), "data/phytoplankton", "VA_ODU_phyto_taxa.csv"))
#"cedr_phyto_taxa.csv"
```
...
data.table::fwrite(event.df, file.path(rprojroot::find_rstudio_root_file(), "data/phytoplankton", "VA_ODU_phyto_event.csv"))
```
